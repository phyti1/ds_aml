...
Da der Type dann für jede Dispostion der gleiche ist, kann diese Variabel entfernt werden.
...
Es gibt nur zwei Transaktionstypen: income und withdrawl.
...
Daher wird der Typ der Karte durch einen boolischen Wert "has_card" ersetzt.
...
Um den Decision Tree noch weiter zu verbessern, wollen wir die verschiedenen Hyperparameter optimieren.
...
cp : der Complexity-Parameter, der die Kompliziertheit des Baums reguliert, indem er die Größe des Baums beschränkt.
Je kleiner cp desto größer der Baum
