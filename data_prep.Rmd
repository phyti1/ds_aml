...
splitrule : die Trennregel, die verwendet wird, um die Qualität einer Trennung zu bewerten. "gini" Unreinheit und "extratrees" sind zwei häufig verwendete Trennregeln.
min.node.size : die minimale Anzahl von Beobachtungen in einem Endknoten.
max.depth : die maximale Tiefe des Baumes. Es ist eine Sequenz von Ganzzahlen von 1 bis 30 mit einem Schritt von 5.
...
Auch die Konfusionsmatrizen werden wieder für d
