...
```{r}
print(paste("Die optimale Anzahl von Parametern ist: ", length(predictors(rfe_dt))))
...
```{r}
print(paste("Die optimale Anzahl von Parametern ist: ", length(predictors(rfe_rf))))
print("Die Parameter sind:")
