...
summary_df_buyers <- merge(summary_df_wide, card_buyers, by = "account_id")
```
...
```{r}
print(paste(nrow(summary_df_non_buyers), nrow(summary_df)))
```
...
final_df <- final_df %>% select(-client_id, -district_id, -district_id.accounts, -disp_id, -type, -loan_id, -account_id, -issued.x, -issued.y)
```
